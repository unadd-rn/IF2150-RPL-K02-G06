...
| *KF06* | *R10* | *Ketika pembeli melakukan login untuk pertama kalinya pada hari tersebut, perangkat lunak akan mendeteksi login harian, memberikan poin quest secara otomatis, dan menyimpan progres reward yang dimiliki pengguna.* |
